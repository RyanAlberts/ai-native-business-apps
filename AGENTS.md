# Keel — Runner Contract (for AI coding agents)

This file follows the [`agents.md`](https://agents.md) convention. Codex,
Cursor, Claude Code, and others auto-load it (or its twin `CLAUDE.md` —
both carry the same contract; the playbooks win if anything ever
disagrees).
